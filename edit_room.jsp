						...
						<div class="panel-body">
							...
							<div class="col-md-4">
								<form method="post" action="edit_room_process.jsp">
									...
									<div class="form-group">
										<label>Housekeeper id </label> <input type="text" class="form-control"
											name="hkid" value="<%=resultset.getString(6)%>" />
									</div>
									<div class="form-group">
										<label>Room Server id </label> <input type="text" class="form-control"
											name="rsid" value="<%=resultset.getString(7)%>" />
									</div>
									<br />
									<div class="form-group">
