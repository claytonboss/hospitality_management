						...
						<div class="panel-body">
							...
							<%
								...
								ResultSet resultset = statement
										.executeQuery("select * from staff where id='" + request.getParameter("id") + "'");
								while (resultset.next()) {
							%>
							<div class="col-md-4">
								<form method="POST" action="edit_staff_process.jsp">
									...
									<div class="form-group">
										<label>First Name </label> <input type="text" class="form-control"
											name="first_name" value="<%=resultset.getString(2)%>" />
									</div>
									<div class="form-group">
